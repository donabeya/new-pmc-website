...
![](pmc1.0realmsmosaiced.png)

初代ワールドには総延長1万マス超の鉄道網がありました。色分けされた路線が走り、駅ごとに砂漠・温泉・メサと雰囲気の違う街が点在します。乗り継いであちこちめぐれました。

<div style="display:flex; gap:8px;">
  <img src="sabakuhommachi.jpg" style="width:32%; height:120px; object-fit:cover; border-radius:8px;">
  <img src="onsen.jpg" style="width:32%; height:120px; object-fit:cover; border-radius:8px;">
  <img src="mesa.jpg" style="width:32%; height:120px; object-fit:cover; border-radius:8px;">
</div>
...
高校生以上、10代後半から20代が中心。<br>
スマホかパソコンでBedrock版を遊べる方が対象です（他機種でも外部サーバーに入れる環境があればOK）。<br>
